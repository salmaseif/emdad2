import 'package:emdad/data/model/response/language_model.dart';

class AppConstants {
  static const String APP_NAME = 'إمداد- سوق الجملة';
  static const String BASE_URL = 'https://emdadb2b.com';
  static const String USER_ID = 'userId';
  static const String NAME = 'name';
  static const String CATEGORIES_URI = '/api/v1/categories';
  static const String CATEGORIES_SUB_URI = '/api/v1/categories';
  static const String CATEGORIES_SUB_SUB_URI = '/api/v1/categories';
  ...
  static const String NEW_REQUST_ORDER_URI = '/api/v1/new-req-order/create';
  static const String new_req_order_GET_URI = '/api/v1/new-req-order/get';
  static const String new_req_order_CONV_URI = '/api/v1/new-req-order/conv/';
  static const String new_req_order_REPLY_URI = '/api/v1/new-req-order/reply/';
  ...
  static const String CHECK_PHONE_ORDER_URI = '/api/v1/auth/check_phone_order';
  static const String VERIFY_PHONE_URI = '/api/v1/auth/verify-phone';
  static const String VERIFY_PHONE_ORDER_URI = '/api/v1/auth/verify_phone_order';
  ...
  static const String UPDATE_PROFILE_DOC_URI = '/api/v1/customer/update-profile-doc';
  ...
  // اضفتها انا
  static const String registerOrLogin = '/api/v1/auth/registerorlogin';
  ...
  static const String TOPIC = 'emdad';
