            ...
            Padding(
              ...
              child: Container(
                ...
                child: CustomButton(
                  ...
                  onTap: () => Navigator.push(context, MaterialPageRoute(builder: (context) => AuthPhoneScreen())),
                ),
              ),
            ),
            InkWell(
              onTap: () {
                ...
                Navigator.push(context, MaterialPageRoute(builder: (context) => AuthPhoneScreen(initialPage: 1)));
              },
              child: Padding(
