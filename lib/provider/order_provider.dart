...
import 'package:emdad/data/model/response/refund_info_model.dart';
import 'package:emdad/data/model/response/refund_result_model.dart';
import 'package:emdad/data/model/response/shipping_method_model.dart';
...
class OrderProvider with ChangeNotifier {
  ...
  int _addressIndex;
  String _timeDelivery;
  int _timeDeliveryIndex = -1;
  String _timeDeliveryData;
  int _dayDeliveryDataIndex = -1;
  String _dayDeliveryData;
  int _selectedDate = 0;
  int _confirmPhone = 0;
  ...
  int get timeDeliveryIndex => _timeDeliveryIndex;
  String get timeDeliveryData => _timeDeliveryData;
  String get dayDeliveryData => _dayDeliveryData;
  int get dayDeliveryDataIndex => _dayDeliveryDataIndex;
  int get selectedDate => _selectedDate;
  int get confirmPhone => _confirmPhone;
  int get shippingIndex => _shippingIndex;
  bool get isLoading => _isLoading;
  bool get isLoadingTime => _isLoadingTime;
  List<ShippingMethodModel> get shippingList => _shippingList;
  int get paymentMethodIndex => _paymentMethodIndex;
  int get notFoundProductIndex => _notFoundProductIndex;
  XFile _imageFile;
  ...
  Future<void> placeOrder(OrderPlaceModel orderPlaceModel, Function callback, List<CartModel> cartList, String addressID, String couponCode, String billingAddressId, String orderNote) async {
    print('placeOrder::::::::::::::: $orderPlaceModel');
  ...
  void setDeliveryTime() {
    _timeDeliveryIndex = 1;
    notifyListeners();
  }

  void clearDeliveryTime() {
    _timeDeliveryIndex = 0;
    notifyListeners();
  }

  void setDeliveryTimeInfo(BuildContext context, int timeSelectedIndex, int selectedDate, String timeData, String dayData) async {
    _isLoadingTime = true;
    _timeDeliveryIndex = timeSelectedIndex;
    _timeDeliveryData = timeData;
    _dayDeliveryData = dayData;
  ...
  void setNotFoundProductMethod(int index) {
    _notFoundProductIndex = index;
    notifyListeners();
  }
