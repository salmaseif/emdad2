...
import 'package:emdad/data/datasource/remote/dio/logging_interceptor.dart';
...
class DioClient {
  ...
  void updateHeader(String token, String countryCode) {
    ...
    countryCode = countryCode == null ? this.countryCode == 'US' ? 'US': this.countryCode.toLowerCase(): countryCode == 'US' ? 'en' : countryCode.toLowerCase();
    this.token = token;
