...
class AuthRepo {
  ...
  Future<ApiResponse> registrationOrLogin(LoginModel loginBody) async {
    try {
      Response response = await dioClient.post(
        AppConstants.registerOrLogin,
  ...
  Future<ApiResponse> updateToken() async {
    ...
    print('=========>Device Token Send5======$_deviceToken');
    try {
      FirebaseMessaging.instance.subscribeToTopic(AppConstants.TOPIC);
      print('=========>Device Token Send4======$_deviceToken');
      Response response = await dioClient.post(
        AppConstants.TOKEN_URI,
        data: {"_method": "put", "cm_firebase_token": _deviceToken},
      );
      print('=========>Device Token Send======$response');
      return ApiResponse.withSuccess(response);
    } catch (e) {
      print('=========>Device Token Send9======$e');
      return ApiResponse.withError(ApiErrorHandler.getMessage(e));
    }
  }
  ...
  //verify phone number
  Future<ApiResponse> checkPhoneOrder(String phone) async {
    try {
      Response response = await dioClient.post(
          AppConstants.CHECK_PHONE_ORDER_URI, data: {"phone": phone});
      return ApiResponse.withSuccess(response);
    } catch (e) {
      return ApiResponse.withError(ApiErrorHandler.getMessage(e));
    }
  ...
  Future<ApiResponse> verifyPhoneOrder(String phone,String otp) async {
    try {
      Response response = await dioClient.post(
          AppConstants.VERIFY_PHONE_ORDER_URI, data: {"phone": phone.trim(), "otp": otp});
      return ApiResponse.withSuccess(response);
    } catch (e) {
      return ApiResponse.withError(ApiErrorHandler.getMessage(e));
    }
