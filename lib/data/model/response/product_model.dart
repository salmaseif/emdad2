...
class Product {
  ...
  double get unitNumbers => _unitNumbers;
  ...
  Product.fromJson(Map<String, dynamic> json) {
    ...
    _unit = json['unit'];
    _unitNumbers = json['unit_numbers'] != null ? double.parse(json['unit_numbers']) : 1;
    ...
    _brandId = json['brand_id'] !=null ? json['brand_id']: 0;
  ...
  Map<String, dynamic> toJson() {
    ...
    data['unit_numbers'] = this._unitNumbers;
