...
class OrderPlaceModel {
  ...
  double _discount;
  String _timeToDelivery;
  String _daysToDelivery;
  ...
  OrderPlaceModel(
        ...
        String daysToDelivery) {
    this._customerInfo = customerInfo;
    this._cart = cart;
    this._paymentMethod = paymentMethod;
    this._discount = discount;
    this._timeToDelivery = timeToDelivery;
    this._daysToDelivery = daysToDelivery;
  }
  ...
  String get timeToDelivery => _timeToDelivery;
  String get daysToDelivery => _daysToDelivery;
  ...
  OrderPlaceModel.fromJson(Map<String, dynamic> json) {
    ...
    _timeToDelivery = json['timeToDelivery'];
    _daysToDelivery = json['daysToDelivery'];
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    data['timeToDelivery'] = this._timeToDelivery;
    data['daysToDelivery'] = this._daysToDelivery;
    return data;
  }
}
